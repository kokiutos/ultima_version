...
$query = "SELECT * FROM tbl_inmueble ORDER BY id DESC limit 1";
...
if(mysqli_num_rows($resultado)){//obtuvimos el ultimo
    ...
    //echo $directorio;
    $directorio = '../build/img/img_inmuebles';
    ...
    if(isset($_FILES["foto1"])){
        ...
        if($tipo != 'image/jpeg' && $tipo != 'image/jpg' && $tipo != 'image/png' && $tipo != 'image/gif'){
            ...
            $ruta = '../build/img/img_inmuebles';
            $query = "UPDATE tbl_inmueble SET url_foto_principal = '$ruta/$nombre' WHERE id='$id_ultima_propiedad'";
